...
Internal helper. Returns the banned IPs of the given family, sorted, each as
a CIDR (/32 or /128), space joined.
...
sub teardown {
	...
	# render updates against an empty ban set without disturbing the retained list
